...
class WavClass:
    ...
    def __init__(self, iwavf):
        ...
        self.x = sp.fromstring(self.wf.readframes(self.nlen), dtype=sp.int16)
        self.d = self.x / 32767.0
        self.t = self.nlen / float(self.fs)
    ...
    def print_wav_info(self):
        ...
        print "# Quantifying bit number:", self.bit
        print "# Sample length:", self.nlen * 8
